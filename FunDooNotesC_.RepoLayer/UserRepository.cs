using Microsoft.EntityFrameworkCore; // Entity Framework Core ka use kar rahe hain
...
{
    // UserRepository class jo Repository<User> ko inherit karti hai aur IUserRepository implement karti hai
